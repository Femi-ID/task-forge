        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Colour = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkspaceMembers", x => new { x.AppUserId, x.WorkspaceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaskLabels_Tasks_TaskItemId",
                        column: x => x.TaskItemId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("24af79c7-1d10-43f4-bbe7-5030b5b2f83a"), "4d86a747-4094-4864-8d07-3781b6f5bad6", "Admin", "ADMIN" },
                    { new Guid("bd461df2-b05b-4a49-bf4d-2e1ecb5a77a9"), "61061ffc-834c-4dba-8f82-3ca82ec624f0", "User", "USER" }
                });
